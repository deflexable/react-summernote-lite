        ...
        return o = t, n = [{
          ...
          value: function value() {
            var e = function e(t, _e2) {
                if (!t) return t;
                if (ht.isVisiblePoint(t) && (!ht.isEdgePoint(t) || ht.isRightEdgePoint(t) && !_e2 || ht.isLeftEdgePoint(t) && _e2 || ht.isRightEdgePoint(t) && _e2 && ht.isVoid(t.node.nextSibling) || ht.isLeftEdgePoint(t) && !_e2 && ht.isVoid(t.node.previousSibling) || ht.isBlock(t.node) && ht.isEmpty(t.node))) return t;
                ...
                if (!n) {
                  ...
                  n = (ht.isLeftEdgePointOf(t, o) || ht.isVoid(i.node)) && !_e2;
                }
                var r = !1;
                if (!r) {
                  ...
                  r = (ht.isRightEdgePointOf(t, o) || ht.isVoid(a.node)) && _e2;
                }
                if (n || r) {
                  if (ht.isVisiblePoint(t)) return t;
                  _e2 = !_e2;
                }
                return (_e2 ? ht.nextPointUntil(ht.nextPoint(t), ht.isVisiblePoint) : ht.prevPointUntil(ht.prevPoint(t), ht.isVisiblePoint)) || t;
              },
